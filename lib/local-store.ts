...
export const EMPTY_OVERRIDES: UserOverrides = {
  ...
  names: {},
  intervals: {},
  categoryBeforeGroceries: {},
  intervalBeforeVariable: {},
  paid: {},
  customCategories: [],
}
...
export function normalizeOverrides(stored: Partial<UserOverrides> | undefined): UserOverrides {
  return {
    ...
    reactivated: stored?.reactivated ?? {},
    confirmed: stored?.confirmed ?? {},
    amounts: stored?.amounts ?? {},
    names: stored?.names ?? {},
    intervals: stored?.intervals ?? {},
    categoryBeforeGroceries: stored?.categoryBeforeGroceries ?? {},
    intervalBeforeVariable: stored?.intervalBeforeVariable ?? {},
    paid: stored?.paid ?? {},
